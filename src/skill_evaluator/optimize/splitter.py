...
Extracted from ai-dev-kit/.test/src/skill_test/optimize/splitter.py
...
from ..core.dataset import EvalRecord, get_dataset_source
...
def generate_bootstrap_tasks(skill_name: str, base_path: Path | None = None) -> list[SkillTask]:
    ...
    if base_path is None:
        ...
        from ..optimize.utils import find_repo_root
